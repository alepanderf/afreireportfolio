                    ...
                    <div className='contact-form'>
                        <form ref={refForm} onSubmit={sendEmail}>
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.icloud.com/iclouddrive/0e2Ycz5mzeHkYLPimfKMSOPig#Alejandro%5Fs%5FResume_(1)" download="Alejandro_freire_resume" className="flat-button resume-button">
                                        DOWNLOAD RESUME
                                    </a>
                                </li>
                            </ul>
